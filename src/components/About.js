...
const About = () => {
  return (
    <div className="max-w-[1320px] mx-6 lg:mx-auto flex justify-center items-center flex-wrap flex-col lg:flex-row my-16 mt-28 md:mt-32">
      <div className="lg:w-[40%] bg-white rounded-lg shadow-lg p-8">
        ...
        <p className="text-base mb-4 my-9 text-gray-500">
          ...
          meals right to your doorstep. Our team of Frontend Developers is
