...
const Body = () => {
  ...
  const handleRatingFilter = () => {
    if (rating === "reset") {
      ...
      setShowFitler(true);
      let filteredList = [...AlllistOfRestuarants].filter((res) => {
        return (
          res.info.avgRating >= parseInt(rating, 10) &&
          res.info.avgRating < parseInt(rating, 10) + 1
        );
      });
              ...
              <div className="flex items-center  mt-2  md:mt-0">
                ...
                >
                  ...
                  >
                    ...
                    <option className="text-base font-semibold" value={"reset"}>
                      Reset
                    </option>
                  </select>
                </span>
