...
const Body = () => {
  ...
  return AlllistOfRestuarants.length === 0 ? (
    ...
    <>
      <div className="search-container py-4 lg:px-36 border-black px-3">
        {filteredlistOfRestuarants?.length === 0 && searchText !== "" ? (
          ...
          <>
            <div className="flex flex-col md:flex-row items-center md:items-center lg:justify-center">
              <div className="flex items-center ">
                <input
                  type="text"
                  className="w-64 md:w-50 text-xs border border-gray-300 shadow-md focus:border-gray-500 transition-all duration-300 px-2 py-2 outline-none  rounded-none md:mr-4"
      ...
      <div>
        {filteredlistOfRestuarants.length > 0 ? (
          <div className="px-14 md:px-28 lg:px-36 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
