...
const RestruarantCards = (props) => {
  ...
  return (
    <div className="overflow-hidden shadow-md md:shadow-none py-4 px-4 md:py-2  hover:shadow-xl transition duration-499 ease hover:translate-y-[-7px] rounded flex flex-col gap-1 text-[0.7rem] text-[#535665] ">
