...
const RestruarantCards = (props) => {
  ...
  return (
    <div className="md:w-60 lg:w-full shadow-md md:shadow-none p-4 md:py-2 hover:shadow-xl rounded flex flex-col gap-1 text-[0.7rem] text-[#535665] ">
      <div className="relative">
        ...
        <span
          className={`absolute text-xl top-0.5 right-0.5 cursor-pointer ${
            !isfav ? "text-[red]" : "text-[gray] hover:text-[red] duration-200"
          }`}
          onClick={() => {
            setfav(!isfav);
            onClickFav(id);
