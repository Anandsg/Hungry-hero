...
const Cart = () => {
  ...
  return (
    <>
      {cartItems.length > 0 ? (
        <div
          className="md:w-3/5 w-[90%] m-auto py-4 min-h-screen flex mt-24 md:mt-28"
          style={{ position: "relative", right: "4rem", width: "70vw" }}
        >
          <>
...
const CartItem = ({
  ...
  return (
    <div
      className="my-2 border-b py-2 md:flex-row flex flex-col text-sm  gap-8 relative"
      style={{ height: "50%" }}
    >
      <button
        className="absolute bottom-1 border-2 border-orange-400 right-0 mt-2 mr-2 px-2 py-1 hover:bg-gray-200 bg-transparent rounded-full focus:outline-none text-orange-400 rounded-3xl"
...
const EmptyCart = () => {
  return (
    <div className="flex flex-col items-center h-screen  mt-20 md:mt-24">
      <img
        src={cook}
        style={{
          height: "60%",
